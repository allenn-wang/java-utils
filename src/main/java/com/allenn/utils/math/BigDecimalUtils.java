package com.allenn.utils.math;

import com.allen.generator.utils.base.ValidateHelper;
...
public class BigDecimalUtils {
	...
	/**
	 * @Description: 除法运算  当发生除不尽的情况时，由scale参数指定精度，以后的数字四舍五入。
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param v1	除数
	...
	/**
	 * @Description: 处理BigDecimal数据，保留scale位小数
	 * @Author: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param value
	...
	/**
	 * @Description: 将object转换为Bigdecimal
	 * @Author: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param value	待转换的数值
	...
	/**
	 * @Description: 将object转换为Bigdecimal,若object为空，则返回resultValue
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param value
	...
	/**
	 * @Description: 将BigDecimal 转换成Long
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param value
	...
	/**
	 * @Description: 将BigDecimal 转换成integer
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param value
