package com.allenn.utils.image;
...
public class ImageUtil {
     ...
     * @throws Exception
     */
    public static void imageLucency(String imgPath, String format, String destPath) {
        try {
            BufferedImage bufferedImage = imageLucency(imgPath);
            ImageIO.write(bufferedImage, format, new File(destPath));
        } catch (Exception e) {
     ...
     * @throws Exception 
     */
    public static BufferedImage imageLucency(String imgPath) {
        BufferedImage targetImage = null;
        try {
            //读取图片
     ...
     * @throws Exception
     */
    public static void formatConvert(BufferedImage bufferedImage, String format, String destPath) {
        try {
            ImageIO.write(bufferedImage, format, new File(destPath));
        } catch (IOException e) {
            throw new RuntimeException("文件格式转换出错");
