package com.allenn.utils.excel;

import com.allen.generator.utils.date.DateFormatUtils;
import com.allen.generator.utils.date.DateUtils;
...
/**
 * @Description: 解析Excel，支持2003、2007
 * @Author: allen wang
 * @Date: 2016-06-22
 */
public class ExcelReadHelper {
	...
	/**
	 * @Description: 根据params、object解析Excel，并且构建list集合
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	...
	/**
	 * @Description: 获取row的数据，利用反射机制构建Object对象
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param row			row对象
	...
	/**
	 * @Description: 根据指定属性的的setter方法给object对象设置值
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param obj		object对象
	...
	/**
	 * @Description: 获取object对象所有属性的Setter方法，并构建map对象，结构为Map<'field','method'>
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	...
	/**
	 * @Description: 获取object对象的所有属性，并构建map对象，对象结果为Map<'field','field'>
	 * @autor: allen wang
	 * @Date: 2016-06-22
	 *
	 * @param object	object对象
